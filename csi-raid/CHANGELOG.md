# v4.0.2
- Add arm7 (32bit) support (https://github.com/JuergenWewer/csi-raid/pull/58)

# v4.0.1
- Preserve name of the PV directory name during archiving (https://github.com/JuergenWewer/csi-raid/pull/59)
...
- Update path creation and implemented possibility save data after removing PV (https://github.com/JuergenWewer/csi-raid/pull/7/)
- Support for running controller outside of cluster (https://github.com/JuergenWewer/csi-raid/pull/9)
- Add a flag to disable leader election (https://github.com/JuergenWewer/csi-raid/pull/22)
- Switched to kubernetes `v1.18.0` to be compatible with `>=1.20` selfLink removal (https://github.com/JuergenWewer/csi-raid/pull/26/)
- Enable mountOptions from StorageClass to PersistentVolume (https://github.com/JuergenWewer/csi-raid/pull/28)
